...
const CardMd = ({item}) => {
    ...
    const [colorActive,setColorActive] = useState(); // quan li trang thai mau san pham
    useEffect(()=>{
    ...
    useEffect(()=>{
        setColorActive(product?.colors[0].id)
    },[product])
...
//   },[]);
    ...
    useEffect(()=>{
        if(show == true){
            ...
            setLinkTo(`/detail?id=${product?.id}`)
        }
    ...
    return (
        <Link ref={cardRef}  to={linkTo} className=''>
            ...
            <div  className='cardMd mb-4 h-100'>
                <div className="img">
                    {
                        product?
                        <img src={import.meta.env.VITE_API_URL+product.colors[0].Avatar} alt="" />
                        // <span>{product?.colors[0].Avatar}</span>
                        :
                ...
                <div className="des">
                    ...
                    <div className="price mt-2  d-flex align-items-end flex-wrap">
                        <div className="old-price me-1">
                            {
                                product?
                                formatCurrencyVND(product.colors[0].Price)+'₫'
                                :
                                '120'
                            }
                        ...
                        {
                                product?
                                formatCurrencyVND(product.colors[0].DiscountPrice)+'₫'
                                :
                                '103$'
                            }
                        </div>
